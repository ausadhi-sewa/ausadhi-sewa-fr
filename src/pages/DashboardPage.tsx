...
import { IconLogout, IconUser, IconShield, IconPlus, IconEdit, IconTrash, IconEye } from "@tabler/icons-react";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-3xl font-bold text-medical-green-600">{products.length}</p>
              <p className="text-sm text-neutral-600">Active products in store</p>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-3xl font-bold text-medical-blue-600">{categories.length}</p>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <p className="text-3xl font-bold text-medical-orange-600 capitalize">{user.role}</p>
